...
name (``"Pinet2024Meg"`` / alias ``"SpanishBCBL"``). Vendored from the internal
neuralhub definition and rewired onto the public ``neuralset`` study base.
"""
...
class _Pinet2024(study.Study):
    ...
    def _load_timeline_events(self, timeline: dict[str, tp.Any]) -> pd.DataFrame:
        ...
        # add language (overridable by subclasses, e.g. PinetAudio2025 uses English)
