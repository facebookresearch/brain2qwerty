...
- **[`brain2qwerty_v1/`](brain2qwerty_v1/)** — [*Non-invasive decoding of typed sentences from human brain activity*](https://arxiv.org/abs/2502.17480) (Nature Neuroscience, 2025). A convolutional encoder and a sentence-level transformer decode one keystroke at a time, synchronised to keystroke onsets.

- **[`brain2qwerty_v2/`](brain2qwerty_v2/)** — *Accurate Decoding of Natural Sentences from Non-Invasive Brain Recordings* (arXiv, under review, 2026). An end-to-end model decodes whole sentences from a single continuous recording window, combining a CTC encoder, a word-level contrastive aligner, and a LoRA-adapted language model.
